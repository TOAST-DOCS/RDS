...
![db-instance-list_ko]({{url.cdn}}/24.03.12/db-instance-list_ko.png)
...
![db-instance-filter_ko]({{url.cdn}}/24.03.12/db-instance-filter_ko.png)
...
![db-instance-detail_ko]({{url.cdn}}/24.03.12/db-instance-detail_ko.png)
...
![db-instance-detail-log_ko]({{url.cdn}}/24.03.12/db-instance-detail-log_ko.png)
...
![db-instance-detail-schema_ko]({{url.cdn}}/24.03.12/db-instance-detail-schema_ko.png)
...
![db-instance-detail-schema-delete-ko]({{url.cdn}}/24.03.12/db-instance-detail-schema-delete-ko.png)
...
![db-instance-detail-user-create-ko]({{url.cdn}}/24.03.12/db-instance-detail-user-create-ko.png)
...
![db-instance-detail-user-cert-ko]({{url.cdn}}/24.03.12/db-instance-detail-user-cert-ko.png)
...
![db-instance-detail-user-modify-ko]({{url.cdn}}/24.03.12/db-instance-detail-user-modify-ko.png)
...
![db-instance-detail-user-delete-ko]({{url.cdn}}/24.03.12/db-instance-detail-user-delete-ko.png)
...
![modify-ha-popup-ko]({{url.cdn}}/24.11.12/modify-ha-popup-ko.png)
...
RDS for {{engine.pascalCase}}에서는 DB 스키마와 사용자를 손쉽게 관리할 수 있도록 콘솔에서 관리 기능을 제공하지만, 사용자가 직접 제어할 수 있도록 설정하는 기능도 제공하고 있습니다. 직접 제어를 사용하면 현재 생성되어 있는 모든 유저에게 아래 권한을 부여합니다.
...
![db-instance-os-upgrade-ko.png]({{url.cdn}}/24.06.11/db-instance-os-upgrade-ko.png)
...
![db-instance-os-upgrade-single-popup-ko.png]({{url.cdn}}/24.06.11/db-instance-os-upgrade-simple-popup-ko.png)
...
![os-upgrade-ha-popup-ko.png]({{url.cdn}}/24.11.12/os-upgrade-ha-popup-ko.png)
...
![db-instance-list-parameter-ko]({{url.cdn}}/24.03.12/db-instance-list-parameter-ko.png)
...
![db-instance-parameter-ha-ko]({{url.cdn}}/24.03.12/db-instance-parameter-ha-ko.png)
...
![db-instance-replica-create-ko]({{url.cdn}}/24.03.12/db-instance-replica-create-ko.png)
...
![db-instance-restart-force-ko]({{url.cdn}}/24.03.12/db-instance-restart-force-ko.png)
...
![db-instance-deletion-protection-ko]({{url.cdn}}/24.03.12/db-instance-deletion-protection-ko.png)
...
> [참고]
> 고가용성 DB 인스턴스의 경우, {{engine.pascalCase}} 쿼리문을 사용해 다른 DB 인스턴스 또는 외부 {{engine.pascalCase}}의 Master로부터 강제로 복제하도록 설정하면 고가용성 및 일부 기능들이 정상적으로 동작하지 않습니다.
...
![db-instance-failover-repair-ko]({{url.cdn}}/24.03.12/db-instance-failover-repair-ko.png)
...
![db-instance-failover-rebuild-ko]({{url.cdn}}/24.03.12/db-instance-failover-rebuild-ko.png)
...
![db-instance-failover-split-ko]({{url.cdn}}/24.03.12/db-instance-failover-split-ko.png)
...
![db-instance-ha-wait-manual-failover-ko]({{url.cdn}}/24.03.12/db-instance-ha-wait-manual-failover-ko.png)
...
RDS for {{engine.pascalCase}}은 사용자의 편의를 제공하기 위하여 사용자 계정에서 제한되는 몇몇 기능들을 수행하는 프로시저들을 자체적으로 제공하고 있습니다.
...
* 아래의 명령어를 통해 외부 {{engine.pascalCase}} 인스턴스로부터 데이터를 백업합니다.
* 외부 {{engine.pascalCase}} 인스턴스(마스터)로부터 가져올 경우
...
* 외부 {{engine.pascalCase}} 인스턴스(슬레이브)로부터 가져올 경우
...
![rds_planed_migration_0]({{url.cdn}}/planned_migration_alarm/image0_kr.png)

마이그레이션 버튼 위에 마우스 포인터를 올리면 자세한 점검 일정을 확인할 수 있습니다.

![rds_planed_migration_1]({{url.cdn}}/planned_migration_alarm/image1_kr.png)
...
![rds_planed_migration_2]({{url.cdn}}/planned_migration_alarm/image2_kr.png)

#### 4. DB 인스턴스 마이그레이션이 끝날 때까지 대기합니다.

DB 인스턴스 상태가 변경되지 않는다면 '새로 고침'하십시오.

![rds_planed_migration_3]({{url.cdn}}/planned_migration_alarm/image3_kr.png)
