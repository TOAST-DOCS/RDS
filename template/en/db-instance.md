...
![db-instance-list_en]({{url.cdn}}/24.03.12/db-instance-list_en.png)
...
준비 중인 유지 관리 작업은 선택 후 **삭제** 또는 **보류** 버튼을 클릭하여 유지 관리 기간에서 제외할 수 있습니다.
사용자 유지 관리는 삭제된 사용자 유지 관리 작업은 취소되며, 다시 유지 관리 기간에 적용하려면 해당 작업을 다시 수행해야 합니다.
...
보류 중인 유지 관리 작업을 선택한 후 다음 버튼을 클릭하여 적용 시점을 선택할 수 있습니다.
...
![db-instance-detail-schema_en]({{url.cdn}}/24.03.12/db-instance-detail-schema_en.png)
...
![db-instance-detail-schema-delete-en]({{url.cdn}}/24.03.12/db-instance-detail-schema-delete-en.png)
...
![db-instance-detail-user-create-en]({{url.cdn}}/24.03.12/db-instance-detail-user-create-en.png)
...
![db-instance-detail-user-cert-en]({{url.cdn}}/24.03.12/db-instance-detail-user-cert-en.png)
...
![db-instance-detail-user-modify-en]({{url.cdn}}/24.03.12/db-instance-detail-user-modify-en.png)
...
![db-instance-detail-user-delete-en]({{url.cdn}}/24.03.12/db-instance-detail-user-delete-en.png)
...
![db-instance-replica-create-en]({{url.cdn}}/24.03.12/db-instance-replica-create-en.png)
...
![db-instance-restart-en]({{url.cdn}}/24.03.12/db-instance-restart-en.png)
...
![db-instance-restart-force-en]({{url.cdn}}/24.03.12/db-instance-restart-force-en.png)
...
![db-instance-deletion-protection-en]({{url.cdn}}/24.03.12/db-instance-deletion-protection-en.png)
...
![db-instance-failover-repair-en]({{url.cdn}}/24.03.12/db-instance-failover-repair-en.png)
...
![db-instance-failover-rebuild-en]({{url.cdn}}/24.03.12/db-instance-failover-rebuild-en.png)
...
![db-instance-failover-split-en]({{url.cdn}}/24.03.12/db-instance-failover-split-en.png)
...
![db-instance-ha-wait-manual-failover-en]({{url.cdn}}/24.03.12/db-instance-ha-wait-manual-failover-en.png)
...
> [참고] 기존 DB 인스턴스 그룹을 DB 클러스터로 마이그레이션할 수 없습니다. 필요 시 고객 센터로 문의하세요.
...
![rds_planed_migration_3]({{url.cdn}}/planned_migration_alarm/image3_en.png)
