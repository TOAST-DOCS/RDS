...
외부 MySQL 백업 파일을 이용하여 DB 인스턴스를 생성할 수 있습니다. 외부 MySQL 백업 파일을 생성할 때 [백업](backup-and-restore-ngoic/#overview) 항목을 참고하여 RDS for MySQL에서 사용하는 Percona XtraBackup과 동일한 버전을 사용해야 합니다.
...
* 자세한 사항은 [멀티파트 업로드](/Storage/Object%20Storage/ko/api-guide-ngoic/#multipart-upload)를 참고합니다.
...
RDS for MySQL의 백업 파일을 이용하여 직접 MySQL의 데이터베이스를 복원할 수 있습니다. 전체 백업에 대해서만 복원이 가능하며, 증분 백업 반영은 지원되지 않습니다. RDS for MySQL 백업 파일을 복원할 때 [백업](backup-and-restore-ngoic/#overview) 항목을 참고하여 RDS for MySQL에서 사용하는 Percona XtraBackup과 동일한 버전을 사용해야 합니다.

(1) [백업 내보내기](backup-and-restore-ngoic/#export) 항목을 참고하여 RDS for MySQL의 백업을 Object Storage로 내보냅니다.
