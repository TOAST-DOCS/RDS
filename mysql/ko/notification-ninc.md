...
## Database > RDS for MySQL > 알림 { #database-rds-for-enginepascalcase-notification }
...
![event_subscription_01_ko](https://static-station.ninc.go.kr/v1/AUTH_0673c1d9b6df4215bb6bf112dfa03805/cdn/prod_rds/mysql/23.04.11/event_subscription_01_ko.png)
...
### 사용자 그룹 생성 { #create-user-group }

![user_group_01_ko](https://static-station.ninc.go.kr/v1/AUTH_0673c1d9b6df4215bb6bf112dfa03805/cdn/prod_rds/mysql/23.06.13/user_group_01_ko.png)
...
### 알림 그룹 생성 { #create-notification-group }

![notification_group_01_ko.png](https://static-station.ninc.go.kr/v1/AUTH_0673c1d9b6df4215bb6bf112dfa03805/cdn/prod_rds/mysql/23.04.11/notification_group_01_ko.png)
...
### 감시 설정 항목 { #monitoring-settings-items }
...
### 감시 설정 추가 { #add-monitoring-setting }

![notification_group_02_ko.png](https://static-station.ninc.go.kr/v1/AUTH_0673c1d9b6df4215bb6bf112dfa03805/cdn/prod_rds/mysql/23.04.11/notification_group_02_ko.png)
...
### 감시 설정 변경 및 삭제 { #change-and-delete-monitoring-settings }

![notification_group_03_ko.png](https://static-station.ninc.go.kr/v1/AUTH_0673c1d9b6df4215bb6bf112dfa03805/cdn/prod_rds/mysql/23.04.11/notification_group_03_ko.png)
