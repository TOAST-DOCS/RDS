...
외부 MySQL 백업 파일을 NHN Cloud의 Object Storage에 업로드하여 RDS for MySQL의 DB 인스턴스로 복원할 수 있습니다. 자세한 사항은 [외부 MySQL 백업을 이용한 복원](backup-and-restore/#restore-from-external) 항목을 참고합니다.
