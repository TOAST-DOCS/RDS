...
![db-instance-backup-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/24.03.12/db-instance-backup-en.png)
![backup-list-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/24.11.12/backup-list-en.png)
...
![db-instance-list-export-obs-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/24.03.12/db-instance-list-export-obs-en.png)

![db-instance-list-export-obs-modal-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/24.03.12/db-instance-list-export-obs-modal-en.png)
...
![db-instance-detail-backup-export-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/24.03.12/db-instance-detail-backup-export-en.png)
...
![db-instance-snapshot-restoration-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/24.03.12/db-instance-snapshot-restoration-en.png)
...
![snapshot-restoration-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/24.03.12/snapshot-restoration-en.png)
...
![point-in-time-restoration-list-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/24.03.12/point-in-time-restoration-list-en.png)
...
![point-in-time-restoration-01-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/24.03.12/point-in-time-restoration-01-en.png)

❶ Select a restore method.

![point-in-time-restoration-02-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/24.03.12/point-in-time-restoration-02-en.png)

❷ Select a restore time. You can restore to the most recent point in time, or you can enter a specific point in time.

![point-in-time-restoration-03-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/24.03.12/point-in-time-restoration-03-en.png)
...
![point-in-time-restoration-04-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/24.03.12/point-in-time-restoration-04-en.png)
...
You can use an external MySQL backup file to create a DB instance. When creating an external MySQL backup file, refer to [Backup](backup-and-restore-ngovc/#overview) and use the same version as the Percona XtraBackup used by RDS for MySQL.
...
* For detailed information, refer to [Multipart Upload](/Storage/Object%20Storage/en/api-guide-ngovc/#multipart-upload).
...
You can use the backup file in RDS for MySQL to restore the database in MySQL directly. Only full backups can be restored; incremental backup reflection is not supported. When restoring a RDS for MySQL backup file, refer to the [Backup](backup-and-restore-ngovc/#overview) and use the same version as Percona XtraBackup used by RDS for MySQL.

(1) Export backup of RDS for MySQL to Object Storage with reference to the [Export Backup](backup-and-restore-ngovc/#export).
