...
* [Auto Minor Version Upgrade](db-instance/#maintenance-auto-minor-version-upgrade)
...
!!! tip "Note"
    This does not apply to DB instances that use a single parameter group. To use automatic upgrade, you must change to a [family parameter group](parameter-group/#family-parameter-group).
...
You can upload an external MySQL backup file to NHN Cloud Object Storage to restore it to DB instance in RDS for MySQL. For more information, refer to [Restore with External MySQL Backup](backup-and-restore/#restore-from-external).
