...
Details about DB engine can be found in [DB Engine](db-engine-ngovc/).
...
High availability DB instances increase availability, data durability, and provide fault tolerant databases. High availability DB instances consist of master and candidate master and are created in different availability zones. Candidate master is a DB instance for failover and is not normally available. For high availability DB instances, backups are performed on candidate master, which avoids performance degradation caused by backups. Several features provided by a high availability DB instance can be found in [High Availability DB Instance](db-instance-ngovc/#ha-db-instance).
...
A parameter group is a set of parameters that allow you to set up a database installed on DB instance. You have to select one parameter group when creating a DB instance. You can change parameter groups freely after creating. Refer to [Parameter Group](parameter-group-ngovc/) for a detailed description of parameter groups.

### DB Security Group

DB security groups are used to restrict access in case of external intrusion. You can allow access to specific port ranges or database ports for incoming and outgoing traffic. You can apply multiple DB security groups to DB instance. For more details on DB security groups, see the [DB security groups](db-security-group-ngovc/).
...
size of backup storage. You can export to user object storage in NHN Cloud if necessary. To prepare for unexpected failures, we recommend that you set up backups to be conducted periodically. For more details on backup, see [Backup and Restore](backup-and-restore-ngovc/).
...
![db-instance-list_en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-list_en.png)
...
![db-instance-filter_en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-filter_en.png)
...
![db-instance-detail_en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-detail_en.png)
...
![db-instance-detail-log_en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-detail-log_en.png)
...
![db-instance-detail-log-bin_en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/24.03.12/db-instance-detail-log-bin_en.png)
...
![db-instance-detail-maintenance_en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-detail-maintenance_en.png)
...
![db-instance-detail-maintenance-immediately_en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-detail-maintenance-immediately_en.png)
...
![db-instance-detail-maintenance-schedule_en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-detail-maintenance-schedule_en.png)
...
![db-instance-detail-schema_en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-detail-schema_en.png)
...
![db-instance-detail-schema-delete-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-detail-schema-delete-en.png)
...
![db-instance-detail-user-create-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-detail-user-create-en.png)
...
![db-instance-detail-user-cert-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-detail-user-cert-en.png)
![db-instance-detail-user-cert-down-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/24.03.12/db-instance-detail-user-cert-down-en.png)
...
![db-instance-detail-user-modify-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-detail-user-modify-en.png)
...
![db-instance-detail-user-delete-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-detail-user-delete-en.png)
...
![modify-ha-popup-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/modify-ha-popup-en.png)
...
❷ If you do not use 'Reboot with Failover', changes will be applied sequentially to the master and candidate master, followed by a restart of the DB instance. For more details, please refer to the [Manual Failover section](db-instance-ngovc/#manual-failover) for High Availability DB instances.
...
![db-instance-os-upgrade-en.png](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-os-upgrade-en.png)
...
![db-instance-os-upgrade-single-popup-en.png](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-os-upgrade-simple-popup-en.png)

When you click the Upgrade Operating System Version for High Availability DB Instance button, the pop-up screen shown below appears. For more information, see [Manual failover item](db-instance-ngovc/#manual-failover) of High Availability DB Instances.
![os-upgrade-ha-popup-en.png](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/os-upgrade-ha-popup-en.png)
...
You can prepare in advance to recover the database of your DB instance in case of failure. You can perform backups from the console whenever necessary or you can set up periodic backups. Refer to [Backup](backup-and-restore-ngovc/#overview) for more information.

## Restoration

You can use backups to restore data to any point in time. Restore always creates a new DB instance and cannot be restored to an existing DB instance. Refer to [Restore](backup-and-restore-ngovc/#restore) for more information.
...
![db-instance-list-parameter-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-list-parameter-en.png)
...
![db-instance-parameter-ha-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-parameter-ha-en.png)

If restart with failover is not enabled, the DB instance is restarted after the changes are sequentially applied to the master and candidate master. For more information, refer to [Manual failover item](db-instance-ngovc/#manual-failover) in a high availability DB instance.

## Recover from backup in object storage

You can upload an external MySQL backup file to user object storage in NHN Cloud to restore it to DB instance in RDS for MySQL. For more information, refer to [Restore with External MySQL Backup](backup-and-restore-ngovc/#restore-from-external).

## Export backup files to the object storage after backup

After backup, you can export backup files to user object storage in NHN Cloud. Refer to [Export Backup](backup-and-restore-ngovc/#export) for more information.
...
![db-instance-replica-create-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-replica-create-en.png)
...
If you do not need to change replication-related settings when selecting a parameter group for a read replica, we recommend that you select the same parameter group as the original DB instance. Refer to [Parameter Group](parameter-group-ngovc/) for a detailed description of the parameter groups.

#### DB Security Group

Select the DB security group that you want to apply to read replicas. Because the rules required for replication are applied automatically, you do not need to add replication-related rules to DB security group separately. Refer to [DB security group](db-security-group-ngovc/) for a detailed description of the DB security group.

#### Backup

Select backup settings for the read replica. Refer to [Backup and Restore](backup-and-restore-ngovc/) for a detailed description of backup.
...
![db-instance-restart-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-restart-en.png)
...
![db-instance-restart-force-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-restart-force-en.png)
...
![db-instance-deletion-protection-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-deletion-protection-en.png)
...
![deletion-protection-popup-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/24.03.12/deletion-protection-popup-en.png)
...
![db-instance-failover-repair-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-failover-repair-en.png)
...
![db-instance-failover-rebuild-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-failover-rebuild-en.png)
...
![db-instance-failover-split-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-failover-split-en.png)
...
![db-instance-ha-wait-manual-failover-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.01.13/db-instance-ha-wait-manual-failover-en.png)
...
![rds_planed_migration_0](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/planned_migration_alarm/26.01.13/image0_en.png)
...
![rds_planed_migration_1](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/planned_migration_alarm/26.01.13/image1_en.png)
...
![rds_planed_migration_2](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/planned_migration_alarm/26.01.13/image2_en.png)
...
![rds_planed_migration_3](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/planned_migration_alarm/26.01.13/image3_en.png)
...
* Make sure you need to allow the outbound direction to remote nodes.
    ...
    * Refer to [DB Security Group](db-security-group-ngovc/) for more information.
...
![patch-security-list-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.05.12/patch-security-list-en.png)
...
![patch-security-detail-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.05.12/patch-security-detail-en.png)

You can check information on security vulnerabilities that can be resolved by proceeding with the security patch.

![patch-security-popup-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.05.12/patch-security-popup-en.png)
...
![patch-security-maintenance-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.05.12/patch-security-maintenance-en.png)
...
![patch-security-running-en](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/26.05.12/patch-security-running-en.png)
