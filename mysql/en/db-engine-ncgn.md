...
## Database > RDS for MySQL > DB Engine { #database-rds-for-enginepascalcase-db-engine }
...
You can configure the minor version to upgrade automatically without having to upgrade it manually. For more information, see [Auto Minor Version Upgrade](db-instance-ncgn/#maintenance-auto-minor-version-upgrade).
