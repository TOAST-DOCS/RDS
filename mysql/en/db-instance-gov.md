...
size of backup storage. You can export to NHN Cloud Object Storage if necessary. To prepare for unexpected failures, we recommend that you set up backups to be conducted periodically. For more details on backup, see [Backup and Restore](backup-and-restore-gov/).
...
* [Auto Minor Version Upgrade](db-instance-gov/#maintenance-auto-minor-version-upgrade)
...
!!! tip "Note"
    This does not apply to DB instances that use a single parameter group. To use automatic upgrade, you must change to a [family parameter group](parameter-group-gov/#family-parameter-group).
...
![db-instance-list_en](https://static.toastoven.net/prod_rds/mysql/26.01.13/db-instance-list_en.png)
...
![db-instance-filter_en](https://static.toastoven.net/prod_rds/mysql/26.01.13/db-instance-filter_en.png)
...
![db-instance-detail-user-cert-en](https://static.toastoven.net/prod_rds/mysql/26.01.13/db-instance-detail-user-cert-en.png)
...
![modify-ha-popup-en](https://static.toastoven.net/prod_rds/mysql/26.01.13/modify-ha-popup-en.png)
...
❷ If you do not use 'Reboot with Failover', changes will be applied sequentially to the Primary and Standby, followed by a restart of the DB instance. For more details, please refer to the [Manual Failover section](db-instance-gov/#manual-failover) for High Availability DB instances.
...
![db-instance-os-upgrade-en.png](https://static.toastoven.net/prod_rds/mysql/26.01.13/db-instance-os-upgrade-en.png)
...
![db-instance-os-upgrade-single-popup-en.png](https://static.toastoven.net/prod_rds/mysql/26.01.13/db-instance-os-upgrade-simple-popup-en.png)
...
![os-upgrade-ha-popup-en.png](https://static.toastoven.net/prod_rds/mysql/26.01.13/os-upgrade-ha-popup-en.png)
...
![db-instance-list-parameter-en](https://static.toastoven.net/prod_rds/mysql/26.01.13/db-instance-list-parameter-en.png)
...
If restart with failover is not enabled, the DB instance is restarted after the changes are sequentially applied to the Primary and Standby. For more information, refer to [Manual failover item](db-instance-gov/#manual-failover) in a high availability DB instance.

<a id="recover-from-backup-in-object-storage"></a>
## Recover from backup in Object Storage { #recover-from-backup-in-object-storage }

You can upload an external MySQL backup file to NHN Cloud Object Storage to restore it to DB instance in RDS for MySQL. For more information, refer to [Restore with External MySQL Backup](backup-and-restore-gov/#restore-from-external).
...
After backup, you can export backup files to Object Storage. Refer to [Export Backup](backup-and-restore-gov/#export) for more information.
...
![db-instance-restart-en](https://static.toastoven.net/prod_rds/mysql/26.01.13/db-instance-restart-en.png)
...
![db-instance-restart-force-en](https://static.toastoven.net/prod_rds/mysql/26.01.13/db-instance-restart-force-en.png)
...
![db-instance-deletion-protection-en](https://static.toastoven.net/prod_rds/mysql/26.01.13/db-instance-deletion-protection-en.png)
