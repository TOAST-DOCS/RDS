...
* Added API v4.0
    * For more information, see [API v4.0 guide](/Database/RDS%20for%20MySQL/en/api-guide-v4.0-ngovc/) document.
...
* Added security patch feature
    ...
    * For more information, refer to the [Security patch](/Database/RDS%20for%20MySQL/en/db-instance-ngovc/#security-patch) documentation.
