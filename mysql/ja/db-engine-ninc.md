...
## Database > RDS for MySQL > DBエンジン { #database-rds-for-enginepascalcase-db-engine }
...
- `5.7から8.0にアップグレードするためのチェックリストの詳細`(https://static-station.ninc.go.kr/v1/AUTH_0673c1d9b6df4215bb6bf112dfa03805/cdn/prod_rds/mysql/23.08.17/Check_5.7_to_8.0_ja.xlsx)を活用して直接確認
