...
* API v4.0の追加
    * 詳細については、[API v4.0 ガイド](/Database/RDS%20for%20MySQL/ja/api-guide-v4.0-ngoic/)ドキュメントを参照してください。
* スナップショットバックアップ機能の追加
    * Cinderストレージスナップショットを利用して、DBのパフォーマンスに影響を与えずにバックアップを実行
* セキュリティパッチ機能を追加
    * OSで発見されたセキュリティの脆弱性(CVE)に対するセキュリティパッチを、メンテナンス作業として実行できます。
    * 詳細については、[セキュリティパッチ](/Database/RDS%20for%20MySQL/ja/db-instance-ngoic/#security-patch)のドキュメントを参照してください。
