...
* [マイナーバージョン自動アップグレード](db-instance/#maintenance-auto-minor-version-upgrade)
...
!!! tip "参考"
    単一パラメータグループを使用するDBインスタンスには適用されません。自動アップグレードを使用するには、[ファミリーパラメータグループ](parameter-group/#family-parameter-group)に変更する必要があります。
