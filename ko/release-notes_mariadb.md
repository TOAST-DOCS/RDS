...
* MariaDB 10.11.18, 11.4.12, 11.8.8 버전 추가
...
* 보안 패치 기능 추가
    ...
    * 자세한 내용은 [보안 패치](/Database/RDS%20for%20MariaDB/ko/db-instance/#security-patch) 문서를 참고하세요.
...
* 콘솔에서 DB 스키마 생성 시 입력 가능한 이름의 최소 길이를 MariaDB와 동일하게 한 글자로 수정
