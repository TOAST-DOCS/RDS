...
## Database > RDS for {{engine.pascalCase}} > 알림 { #database-rds-for-enginepascalcase-notification }

<a id="event"></a>
## 이벤트 { #event }

이벤트는 RDS for {{engine.pascalCase}}이나 사용자에 의해 발생한 중요한 사건을 의미합니다. 이벤트는 이벤트 유형, 발생 일시, 원본 소스와 메시지로 구성됩니다. 이벤트는 콘솔에서 조회 가능하며, 구독을 통해 이메일, SMS으로 이벤트 발생 알림을 받을 수 있습니다. 이벤트의 유형과 발생 가능한 이벤트는 아래와 같습니다.
...
![event_subscription_01_ko]({{url.cdn}}/23.04.11/event_subscription_01_ko.png)
...
![user_group_01_ko]({{url.cdn}}/23.06.13/user_group_01_ko.png)
...
![notification_group_01_ko.png]({{url.cdn}}/23.04.11/notification_group_01_ko.png)
...
![notification_group_02_ko.png]({{url.cdn}}/23.04.11/notification_group_02_ko.png)
...
![notification_group_03_ko.png]({{url.cdn}}/23.04.11/notification_group_03_ko.png)
