...
* API v4.0 추가
    * 자세한 내용은 [API v4.0 가이드](/Database/RDS%20for%20MySQL/ko/api-guide-v4.0-ngovc/) 문서를 참고하세요.
* 스냅숏 백업 기능 추가
    * Cinder 스토리지 스냅숏을 사용하여 DB 성능에 영향을 주지 않고 백업을 수행합니다.
* 보안 패치 기능 추가
    * OS에서 발견된 보안 취약점(CVE)에 대한 보안 패치를 유지 관리 작업으로 수행할 수 있습니다.
    * 자세한 내용은 [보안 패치](/Database/RDS%20for%20MySQL/ko/db-instance-ngovc/#security-patch) 문서를 참고하세요.
