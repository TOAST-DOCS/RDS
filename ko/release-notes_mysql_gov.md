...
* 보안 패치 기능 추가
    ...
    * 자세한 내용은 [보안 패치](/Database/RDS%20for%20MySQL/ko/db-instance-gov/#security-patch) 문서를 참고하세요.
...
* API v4.0 추가
    * 자세한 내용은 [API v4.0 가이드](/Database/RDS%20for%20MySQL/ko/api-guide-v4.0-gov/) 문서를 참고하세요.
* 스냅숏 백업 기능 추가
