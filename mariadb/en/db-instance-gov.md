...
## Database > RDS for MariaDB > DB Instance { #database-rds-for-enginepascalcase-db-instance }
...
You can upload an external MariaDB backup file to NHN Cloud Object Storage to restore it to DB instance in RDS for MariaDB. For more information, refer to [Restore with External MariaDB Backup](backup-and-restore-gov/#restore-from-external).
...
!!! danger "Caution"
    The account for replication must be created in MariaDB of the replication target (Master).
...
!!! danger "Caution"
    The replication account must be created in the replication target (Master) MariaDB.
...
![patch-security-list-en](https://static.toastoven.net/prod_rds/mariadb/26.05.12/patch-security-list-en.png)
...
![patch-security-detail-en](https://static.toastoven.net/prod_rds/mariadb/26.05.12/patch-security-detail-en.png)

You can check information on security vulnerabilities that can be resolved by proceeding with the security patch.

![patch-security-popup-en](https://static.toastoven.net/prod_rds/mariadb/26.05.12/patch-security-popup-en.png)
...
![patch-security-maintenance-en](https://static.toastoven.net/prod_rds/mariadb/26.05.12/patch-security-maintenance-en.png)
...
![patch-security-running-en](https://static.toastoven.net/prod_rds/mariadb/26.05.12/patch-security-running-en.png)
