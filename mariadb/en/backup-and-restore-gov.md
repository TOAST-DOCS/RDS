...
## Database > RDS for MariaDB > Backup and Restoration { #database-rds-for-enginepascalcase-backup-and-restoration }
...
### Restoration with External MariaDB Backup { #restore-from-external }
...
### Restoration by Using RDS for MariaDB Backup { #restoration-by-using-rds-for-enginepascalcase-backup }
