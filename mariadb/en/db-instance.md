...
You can upload an external MariaDB backup file to NHN Cloud Object Storage to restore it to DB instance in RDS for MariaDB. For more information, refer to [Restore with External MariaDB Backup](backup-and-restore/#restore-from-external).
