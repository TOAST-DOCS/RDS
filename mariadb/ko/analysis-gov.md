...
## Database > RDS for MariaDB > 분석 { #database-rds-for-enginepascalcase-analysis }
...
!!! tip "알아두기"
    수집된 데이터는 내부 백업 스토리지에 저장되며 별도로 과금하지 않습니다.
...
!!! tip "알아두기"
    DB 인스턴스 수정 화면에서 Slow Query 분석 기능을 사용하지 않도록 설정할 수 있습니다.
