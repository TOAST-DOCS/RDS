...
## Database > RDS for MariaDB > 백업 및 복원 { #database-rds-for-enginepascalcase-backup-and-restoration }
...
### 외부 MariaDB 백업을 이용한 복원 { #restore-from-external }
...
### RDS for MariaDB 백업을 이용한 복원 { #restoration-by-using-rds-for-enginepascalcase-backup }

RDS for MariaDB의 백업 파일을 이용하여 직접 MariaDB의 데이터베이스를 복원할 수 있습니다. 전체 백업에 대해서만 복원이 가능하며, 증분 백업 반영은 지원되지 않습니다.

(1) [백업 내보내기](backup-and-restore-gov/#export) 항목을 참고하여 RDS for MariaDB의 백업을 Object Storage로 내보냅니다.
