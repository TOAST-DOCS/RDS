...
You can upload an external MariaDB backup file to user object storage in NHN Cloud to restore it to DB instance in RDS for MariaDB. For more information, refer to [Restore with External MariaDB Backup](backup-and-restore-gov/#restore-from-external).
