...
## Database > RDS for MariaDB > DBエンジン { #database-rds-for-enginepascalcase-db-engine }
...
マイナーバージョンは、ユーザーが手動でアップグレードしなくても自動的にアップグレードされるよう設定できます。詳細については、「[マイナーバージョン自動アップグレード](db-instance-gov/#maintenance-auto-minor-version-upgrade)」を参照してください。
