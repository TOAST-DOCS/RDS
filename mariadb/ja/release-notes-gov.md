...
* セキュリティパッチ機能を追加
    ...
    * 詳細については、[セキュリティパッチ](/Database/RDS%20for%20MariaDB/ja/db-instance-gov/#security-patch)のドキュメントを参照してください。
...
* API v4.0の追加
    * 詳細については、[API v4.0 ガイド](/Database/RDS%20for%20MariaDB/ja/api-guide-v4.0-gov/)ドキュメントを参照してください。
* スナップショットバックアップ機能の追加
