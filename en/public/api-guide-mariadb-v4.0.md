...
| dbEngineVersionFamily | String | DB engine version family code (has a value only for family parameter groups) |
...
| parameters.templateRange | Object | Parameter template range (has a value only for family parameter groups) |
| parameters.templateRange.coversAllVersions | Boolean | Whether the range covers all DB engine versions of the family |
