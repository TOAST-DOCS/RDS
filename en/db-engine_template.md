...
You can configure the minor version to upgrade automatically without having to upgrade it manually. For more information, see [Miner Version Upgrade](db-instance/#maintenance-auto-minor-version-upgrade).
