...
* Added API v4.0
    * For more information, see [API v4.0 guide](/Database/RDS%20for%20MySQL/en/api-guide-v4.0-ninc/) document.
...
* Added security patch feature
    ...
    * For more information, refer to the [Security patch](/Database/RDS%20for%20MySQL/en/db-instance-ninc/#security-patch) documentation.
