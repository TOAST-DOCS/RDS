...
| INSTC_46_04 | INSTANCE          | No      | Limit the number of read replicas                |
...
| INSTC_61_01 | INSTANCE          | Example        | Standby rebuilding completed                        |
...
| TENAT_05_04 | TENANT            | Example        | Limit the number of read replicas                |
...
![event_subscription_01_en]({{url.cdn}}/23.04.11/event_subscription_01_en.png)
...
![user_group_01_en]({{url.cdn}}/23.06.13/user_group_01_en.png)
...
![notification_group_01_en.png]({{url.cdn}}/23.04.11/notification_group_01_en.png)
...
![notification_group_03_en.png]({{url.cdn}}/23.04.11/notification_group_03_en.png)
