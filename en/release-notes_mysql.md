...
* Added security patch feature
    ...
    * For more information, refer to the [Security patch](/Database/RDS%20for%20MySQL/en/db-instance/#security-patch) documentation.
...
### Bug Fixes { #january-13-2026-bug-fixes }
...
### Bug Fixes { #may-13-2025-bug-fixes }
...
### Feature Updates { #february-11-2025-feature-updates }
...
### Feature Updates { #september-12-2023-feature-updates }
...
### Feature Updates { #august-17-2023-feature-updates }
...
### Added Features { #august-9-2022-added-features }
...
### Added Features { #may-10-2022-added-features }
...
### Added Features { #november-9-2021-added-features }
...
### Feature Updates { #november-9-2021-feature-updates }
...
### Bug Fixes { #november-9-2021-bug-fixes }
...
### Feature Updates { #september-14-2021-feature-updates }
...
### Bug Fixes { #september-14-2021-bug-fixes }
...
### Feature Updates { #august-25-2021-feature-updates }
...
### Bug Fixes { #august-25-2021-bug-fixes }
...
### Feature Updates { #july-13-2021-feature-updates }
...
### Bug Fixes { #july-13-2021-bug-fixes }
...
### Feature Updates { #june-15-2021-feature-updates }

* Monitoring system reorganized

<a id="june-15-2021-bug-fixes"></a>
### Bug Fixes { #june-15-2021-bug-fixes }
...
### Bug Fixes { #april-13-2021-bug-fixes }
...
### Bug Fixes { #february-16-2021-bug-fixes }
...
### Added Features { #january-19-2021-added-features }
...
### Added Features { #december-15-2020-added-features }
...
### Bug Fixes { #november-10-2020-bug-fixes }
...
### Bug Fixes { #october-13-2020-bug-fixes }
...
### Added Features { #september-22-2020-added-features }
...
### Added Features { #september-15-2020-added-features }
...
### Bug Fixes { #august-11-2020-bug-fixes }
...
### Added Features { #july-14-2020-added-features }
...
### Added Features { #december-10-2019-added-features }
...
### Feature Updates { #september-24-2019-feature-updates }
...
### Added Features { #july-23-2019-added-features }

* Default Alarm added
* Monitoring Item added

<a id="july-23-2019-feature-updates"></a>
### Feature Updates { #july-23-2019-feature-updates }
...
### Added Features { #june-27-2019-added-features }
...
### Feature Updates { #may-14-2019-feature-updates }
...
### Bug Fixes { #may-14-2019-bug-fixes }
...
### Feature Updates { #march-12-2019-feature-updates }
...
### Bug Fixes { #march-12-2019-bug-fixes }
...
### Feature Updates { #january-29-2019-feature-updates }
...
### Bug Fixes { #december-14-2018-bug-fixes }
...
### Feature Updates { #december-11-2018-feature-updates }
...
### Feature Updates { #october-23-2018-feature-updates }
...
### Added Features { #october-16-2018-added-features }
...
### Added Features { #august-28-2018-added-features }
...
### Added Features { #july-24-2018-added-features }

* Also supports MySQL 5.7.15

<a id="july-24-2018-bug-fixes"></a>
### Bug Fixes { #july-24-2018-bug-fixes }
...
### Added Features { #may-29-2018-added-features }
...
### Bug Fixes { #april-24-2018-bug-fixes }
...
### Bug Fixes { #march-22-2018-bug-fixes }
