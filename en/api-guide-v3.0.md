...
| backup.replicationRegion | Enum | N | Backup replication region<br/>- KR1: `Korea (Pangyo) Region`<br/>- KR2: `Korea (Pyeongchon) Region`<br/>- JP1: `Japan (Tokyo) Region` |
...
| replicationRegion | Enum | Backup replication region<br/>- KR1: `Korea (Pangyo) Region`<br/>- KR2: `Korea (Pyeongchon) Region`<br/>- JP1: `Japan (Tokyo) Region` |
...
| replicationRegion | Enum | N | Backup replication region<br/>- KR1: `Korea (Pangyo) Region`<br/>- KR2: `Korea (Pyeongchon) Region`<br/>- JP1: `Japan (Tokyo) Region` |
