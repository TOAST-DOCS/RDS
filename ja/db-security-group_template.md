...
## Database > RDS for {{engine.pascalCase}} > DBセキュリティグループ { #database-rds-for-enginepascalcase-db-security-group }
...
* DBセキュリティグループの名前は、1～100の間の英字、数字、一部の記号(-、_、.)のみ使用でき、最初の文字は英字のみ使用できます。

<a id="applying-db-security-groups"></a>
### DBセキュリティグループの適用 { #applying-db-security-groups }
