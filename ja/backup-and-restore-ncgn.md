...
* 詳細については、 [マルチパートアップロード](/Storage/Object%20Storage/ja/api-guide-ncgn/#_45)を参照してください。
...
(1) [バックアップのエクスポート](backup-and-restore-ncgn/#export)の項目を参照して、RDS for MySQLのバックアップをオブジェクトストレージにエクスポートします。
