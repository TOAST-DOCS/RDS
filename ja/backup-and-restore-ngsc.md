...
* 詳細については、 [マルチパートアップロード](/Storage/Object%20Storage/ko/api-guide-ngsc/#_44)を参照してください。
...
(1) [バックアップのエクスポート](backup-and-restore-ngsc/#export)の項目を参照して、RDS for MySQLのバックアップをオブジェクトストレージにエクスポートします。
