...
| backup.replicationRegion | Enum | N | バックアップ複製リージョン<br/>- KR4: `韓国(テグ)リージョン` |
...
| replicationRegion | Enum | バックアップ複製リージョン<br/>- KR4: `韓国(テグ)リージョン` |
...
| replicationRegion | Enum | N | バックアップ複製リージョン<br/>- KR4: `韓国(テグ)リージョン` |
