## Database > RDS for {{engine.pascalCase}} > バックアップおよび復元
...
### <a id="set-auto-backup"></a>自動バックアップ設定
...
### 外部{{engine.pascalCase}}バックアップを利用した復元
...
### RDS for {{engine.pascalCase}}のバックアップを利用した復元
