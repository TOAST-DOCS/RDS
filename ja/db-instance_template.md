...
外部{{engine.pascalCase}}のバックアップファイルをNHN CloudのObject Storageにアップロードして、RDS for {{engine.pascalCase}}のDBインスタンスに復元することができます。詳細は、[外部{{engine.pascalCase}}バックアップを利用した復元](backup-and-restore/#restore-from-external)を参照してください。
