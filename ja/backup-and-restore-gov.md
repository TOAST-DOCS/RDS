...
* 詳細については、 [マルチパートアップロード](/Storage/Object%20Storage/ja/api-guide-gov/#_45)を参照してください。
...
(1) [バックアップのエクスポート](backup-and-restore-gov/#export)の項目を参照して、RDS for MySQLのバックアップをオブジェクトストレージにエクスポートします。
