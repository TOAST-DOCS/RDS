...
![backup-list-ja](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds/mysql/24.11.12/backup-list-ja.png)
...
* 詳細については、 [マルチパートアップロード](/Storage/Object%20Storage/ko/api-guide-ngovc/#_44)を参照してください。
...
(1) [バックアップのエクスポート](backup-and-restore-ngovc/#export)の項目を参照して、RDS for MySQLのバックアップをオブジェクトストレージにエクスポートします。
