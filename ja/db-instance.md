...
DBインスタンスはHDD、SSDの2種類のストレージをサポートします。ストレージの種類によって性能と価格が異なるため、データベースのワークロードに応じて適切なストレージの種類を選択する必要があります。ストレージは最小20GB～2TBまで作成できます。
...
DBインスタンス作成時に接続するVPCサブネットを選択する必要があります。同じサブネットに接続されたComputeサービスのインスタンス間には、別のFloating IPなしで通信できます。
